    ...
    <Box widht={"100%"} sx={{ py: 4 }}>
      ...
      >
        <Box>
          ...
          >
            A robust web-based Real-Time Chat App developed by Arindom Saikia.
          </Typography>
      ...
      <Box mt={10}>
        <Stack spacing={2}>
          ...
          <Typography variant="body1">
            ConnectGO is a real-time web-based chat application developed by
            Arindom Saikia. Boasting not only a visually appealing UI but also
            ...
            system, ConnectGo ensures not just connectivity but a symphony of
